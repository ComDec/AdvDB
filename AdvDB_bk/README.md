...
Distributed replicated database simulator implementing serializable snapshot isolation (SSI), multi-version storage, and the available-copies (ROWAA) replication rules.
