...
Author: Xi Wang, Sihang Zhao

## Overview

This simulator implements the RepCRec. It models a centralized Transaction Manager (TM) coordinating ten data sites with replicated and non-replicated variables under Serializable Snapshot Isolation (SSI) and the Available Copies (ROWAA) algorithm.
...
# packing
reprozip trace python main.py test_basic.txt
